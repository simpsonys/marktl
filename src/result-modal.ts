...
export class MarktlResultModal extends Modal {
  ...
  private copyLink: (outputPath: string) => Promise<string>;

  constructor(app: App, summary: ExportSummary, copyLink: (outputPath: string) => Promise<string>) {
    super(app);
  ...
  onOpen(): void {
    ...
    contentEl.createEl('p', {
      ...
      text: this.summary.shareTarget === 'static-bundle'
